		...
		try {
			comunicacao = new Thread() {
				...
				public void run() {
					...
					/*
					 * TelaJogoController.outputStream =
					 * TelaJogoController.socket.getOutputStream(); TelaJogoController.writer = new
					 * OutputStreamWriter(TelaJogoController.outputStream);
					 * TelaJogoController.bufferWriter = new
					 * BufferedWriter(TelaJogoController.writer);
					 * TelaJogoController.bufferWriter.write((txf_nickName.getText()));
					 * TelaJogoController.bufferWriter.flush();
					 */
					} catch (Exception e) {
					}
				}
